...
# Copyright 2011 nholuongut Broadbent (https://github.com/nholuongut/scm-breeze). All Rights Reserved.
...
test_scmb_expand_args() {
  ...
  # See token_quote() source and https://github.com/nholuongut/scm-breeze/issues/260
  # local e1="one" e2="two" e3="three" e4="four" e5="five" e6="six" e7='$dollar' e8='two words'
  # local error="Args not expanded correctly"
  # assertEquals "$error" "'one' 'three' 'six'" \
...
test_git_commit_prompt() {
  ...
  commit_msg="\"nholuongut's git commit prompt function!\""
  dbl_escaped_msg="\\\\\"nholuongut's git commit prompt function\"'"'!'"'\"\\\\\""
